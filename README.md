...
## Introdução 
  Para aprender os principais comandos do Git, cria-se um repositório no Github para ser trabalhado.
## Objetivo
  Entender para que e quando utilizar os comando: "git remote add origin <url>", "git push --set-upstream origin master", "git pull", "git fetch", "git merge", "git commit -a -m"nome" ", "git status", "git push" e outros.
## Conclusão
  Atráves da ferramenta Git, é possível utilizar comandos para fazer alterações no seu repositório. Assim cada comando serve a um propósito específico e permite que você gerencie as mudanças, ajudando a manter o código organizado, a evitar conflitos e a gerenciar o fluxo de trabalho de maneira eficaz.
## Relatório Git e Github (capituras de telas)
